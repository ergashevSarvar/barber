              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    ProfileScreenTmp(Icons.person_rounded, "Login",
                        state.userProfile.username),
                    ProfileScreenTmp(Icons.email, "Email",
                        state.userProfile.userEmail),
                    ProfileScreenTmp(Icons.person_rounded, "Ism",
                        state.userProfile.firstname),
                    ProfileScreenTmp(Icons.person_rounded,
                        "Familiya", state.userProfile.lastname ?? ""),
                    ProfileScreenTmp(Icons.phone,
                        "Telegram telefon raqam", state.userProfile.telegramPhoneNumber ?? ""),
